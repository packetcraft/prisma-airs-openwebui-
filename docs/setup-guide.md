...
4. Navigate back to `OpenWebUI`, click 'new Chat' and click the **Model Selection** dropdown at the top center. You should see `llama2-uncensored:latest` in the list.
