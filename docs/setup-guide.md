...
4. Navigate back to `http://host.docker.internal:11434`, click the **Model Selection** dropdown at the top center. You should see `llama2-uncensored:latest` in the list.
