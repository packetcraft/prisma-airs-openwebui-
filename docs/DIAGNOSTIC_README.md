...
1. **File**: Use `functions/prisma_airs_diagnostic.py` (v4.3) from this repository.
2. **Installation**: Follow the standard [Setup Guide](https://www.google.com/search?q=./docs/setup-guide.md) to add the function to Open WebUI.
...
**This mode is strictly for testing and research purposes.** Because it does not redact sensitive data or block malicious payloads, it should only be used in isolated research environments. For production use or general user access, please switch to the **[Blocking Mode v3.1](https://www.google.com/search?q=./README.md)** version of this script.
